...
namespace Game.CharacterSystem.Data
{
    ...
    public class EnemyPhaseData
    {
        ...
        /// <summary>
        /// 이전 페이즈의 체력 기준으로 이 페이즈로 전환되는 임계값 (0.0 ~ 1.0, 예: 0.2 = 20% 이하)
        ...
        /// <summary>
        /// 이 페이즈에서 표시할 이름 (null이면 기본 DisplayName 사용)
        /// </summary>
        ...
        /// <summary>
        /// 이 페이즈에서 사용할 스킬 덱 (null이면 기본 덱 사용)
        /// </summary>
        [Header("페이즈 전용 덱")]
