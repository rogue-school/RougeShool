    ...
    public interface IEnemyHandManager
{
    ...
    void RestoreCardToHand(ISkillCard card, SkillCardSlotPosition slotPosition);

    /// <summary>
    /// 핸드카드를 직접 설정합니다. (저장 시스템용)
    /// </summary>
    /// <param name="cards">설정할 카드들</param>
    void SetHandCards(System.Collections.Generic.List<ISkillCard> cards);
    ...
    ISkillCard GetCardInSlot(SkillCardSlotPosition slotPosition);
    }
}
