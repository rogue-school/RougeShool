...
|--------------|--------------|-----------|------|------------------------|---------------------------|------------------------|----------------------|------|
| **SaveSystemInstaller** | `Game.SaveSystem.Manager` | `Installer/SaveSystemInstaller.cs` | 세이브 시스템용 Zenject 설치자 (필요한 세이브 컴포넌트 바인딩) | `InstallBindings()` | - | Save 관련 매니저/데이터를 AsSingle로 바인딩 (CoreSystem.SaveManager와 협업) | StageScene/CombatScene 세이브 구성, AutoSaveManager/StageProgressCollector 설정 | ✅ 사용 중 |
